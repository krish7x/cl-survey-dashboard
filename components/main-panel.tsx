...
export default function MainPanel() {
  ...
  return (
    <div className="px-10 flex flex-col gap-5 py-6 w-full h-full ">
      ...
      {SURVEYS.map(({ projectId, name, project, lastModified }) => (
        <div
          key={name}
          className="flex justify-between border-b border-b-navBorder py-4 cursor-pointer hover:bg-green-100"
        >
